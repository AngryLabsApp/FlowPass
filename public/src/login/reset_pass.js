 import { createClient } from "https://esm.sh/@supabase/supabase-js@2";
    ...
    const toggleType = (el) => el.type === "password" ? (el.type = "text") : (el.type = "password");
    toggle1.addEventListener("click", () => toggleType(passEl));
    toggle2.addEventListener("click", () => toggleType(confEl));
    ...
    try {
      ...
      stepMsg.textContent = session?.user?.email
        ? `Usuario verificado: ${session.user.email}. Ingresa tu nueva contraseña.`
