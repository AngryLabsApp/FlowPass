...
function getNavHTML(activeKey) {
  const links = [
    ...
    { href: 'ingreso.html', icon: 'key', label: 'Check-in', key: 'ingreso.html' },
    { href: 'historial.html', icon: 'history', label: 'Historial', key: 'historial.html' },
  ];
  const items = links
...
function detectActiveKey() {
  ...
  if (file === '' || file === 'index' || file === 'index.htm') return 'index.html';
  return file;
}
